...
public class NewXPath extends Spider {
    private boolean focePlay;
    private String focePlayUrl = "";
    @Override
    ...
    public String playerContent(String flag, String id, List<String> vipFlags) {
        try {
            ...
            if (focePlay) {
                ...
                webUrl = rule.getPlayUrl().isEmpty() ? id : rule.getPlayUrl().replace("{playUrl}", id);
            }
            SpiderDebug.log(webUrl);
            JSONObject result = new JSONObject();
            result.put("parse", 1);
            result.put("playUrl", "");
            if (!rule.getPlayUrl().isEmpty()) {
...
//                result.put("ua", rule.getPlayUa());
    ...
    private String[] videoFormatList = new String[]{".m3u8", ".mp4", ".mpeg", ".flv", ".mp3", ".m4a"};
    ...
    protected void loadRuleExt(String json) {
        try {
            ...
            focePlay = jsonObj.optBoolean("focePlay", false);
